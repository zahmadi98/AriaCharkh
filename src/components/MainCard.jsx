...
{
    return(
    <div className="max-w-[45rem] w-full bg-white rounded-xl h-[50rem] shadow-md overflow-hidden">
     <h1 className="text-right text-xl pt-5 pb-3 pr-5 text text-[#ED1A3B] font-vazir">
        {Title}
     </h1>
