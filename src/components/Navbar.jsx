...
const Navbar = () => {
  return (
    <div className="w-full font-vazir h-[4.125rem] md:px-20 py-2 flex items-center px-5 justify-between bg-white shadow">
        

        <div className="flex items-center gap-4">
            <img src={logo} alt="Logo" className="h-12 w-auto hidden md:block" />

            <div className="md:w-[31.688rem] relative">
                <input
                 type="text"
                 placeholder="دنبال چه محصولی هستی؟"
                 className="w-full text-xs text-right pl-10 py-2 px-3 rounded-lg border border-gray-200 bg-white md:bg-[#EDEDED] shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-300"
                />
